...
public:
    ...
    virtual fn_createinterface              Init(char const* pShaderAPIDLL, IMaterialProxyFactory *pMaterialProxyFactory, fn_createinterface fileSystemFactory, fn_createinterface cvarFactory = NULL) = 0;
